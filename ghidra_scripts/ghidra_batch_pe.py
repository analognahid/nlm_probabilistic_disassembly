...
output_dir_path = '/home/raisul/DATA/temp/ghidra_x86_pe_msvc_O2_debug/'
...
filtered_files  = [os.path.join(BIN_PATH, f) for f in os.listdir(BIN_PATH) if f.endswith(".exe")]
